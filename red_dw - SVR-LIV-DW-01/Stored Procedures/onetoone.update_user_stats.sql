...
FROM (
	...
	GROUP BY
	 GROUPING SETS (
	 (dim_date.fin_year, cast (dim_date.fin_month_no AS VARCHAR(3)),dim_fed_hierarchy_history.fed_code),
	 (dim_date.fin_year,dim_fed_hierarchy_history.fed_code)
	 )
