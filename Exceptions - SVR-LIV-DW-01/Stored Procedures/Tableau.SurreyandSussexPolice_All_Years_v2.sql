...
,[ClientOrder] = CASE  
		...
		WHEN client_name = 'Metropolitan Police' THEN 7
		WHEN client_name = 'Cambridgeshire Constabulary' THEN 6
		WHEN client_name = 'Wiltshire Constabulary' THEN 5
		WHEN client_name = 'British Transport Police' THEN 4
		WHEN client_name = 'Suffolk Constabulary' THEN 3
...
GROUP BY CASE
      ...
      WHEN client_name = 'Sussex Police' THEN 1 END ,
         ...
         CASE WHEN dim_matter_header_current.master_client_code='817395' THEN dim_detail_core_details.[suffolk_police_source_of_instruction]  ELSE dim_detail_claim.[source_of_instruction] END,
