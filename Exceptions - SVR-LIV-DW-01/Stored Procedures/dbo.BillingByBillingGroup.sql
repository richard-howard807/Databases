...
/*
	LD 20190411 Fixed the issue with VAT for unbilled disbursements
*/
...
--DECLARE @NMI1056 VARCHAR(500) = 'C'
--,@EndDate DATE = '20190331'
...
,COALESCE(VchrDetail.Amount,WorkAmt) * (tax.Rate/100) AS DisbVAT
,NULL	DisbJoin
...
-- ON VchrDetail.Voucher=VchrTax.Voucher 
 ...
 LEFT OUTER JOIN (SELECT 
  ...
  WHERE NxEndDate = '9999-12-31 00:00:00.000') tax ON UnbilledWIP.TaxCode = tax.[TaxCode]
