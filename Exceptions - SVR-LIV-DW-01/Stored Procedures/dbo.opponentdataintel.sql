...
GO
CREATE
PROCEDURE [dbo].[opponentdataintel]
...
--WHERE dim_matter_header_current.matter_description <>'ML'
--AND dim_detail_outcome.exclude_from_reports = 0 
--AND dim_matter_header_current.reporting_exclusions = 0 
----AND dim_detail_core_details.suspicion_of_fraud = 
END 
