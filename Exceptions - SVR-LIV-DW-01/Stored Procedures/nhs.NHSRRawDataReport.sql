...
SET @GraphStart='2022-04-01'
SET @GraphEnd='2023-03-31'
...
----------- NEW Damages Tranch to Replace case value -------------------------------
...
,CASE WHEN dim_detail_health.[nhs_scheme]  IN ('LTPS','PES','DH Liab') THEN 'Non Clinical' 
WHEN  dim_detail_health.[nhs_scheme]  IN ('CNST','DH CL','ELS','Inquest funding','CNSGP','ELSGP','ELSGP (MDDUS)','ELSGP (MPS)','CNSC') THEN 'Clinical' 
END AS ClinicalNonClinical
