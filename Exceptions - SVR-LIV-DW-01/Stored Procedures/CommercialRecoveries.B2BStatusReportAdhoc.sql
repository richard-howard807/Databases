...
CREATE PROCEDURE [CommercialRecoveries].[B2BStatusReportAdhoc] 

AS
BEGIN
SELECT 
clNo
,dbfile.fileID AS mt_int_code
,usrFullName
,clName
...
AND clNo IN ('W22098','W22148','W22136')
AND red_dw.dbo.datetimelocal(dbFile.Created) BETWEEN '2020-01-01' AND '2021-08-31'
