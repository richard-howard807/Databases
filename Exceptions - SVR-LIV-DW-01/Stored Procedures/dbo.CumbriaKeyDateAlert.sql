...
CREATE PROCEDURE [dbo].[CumbriaKeyDateAlert]
AS
BEGIN
SET NOCOUNT ON
...
,'Cumbria ' + ISNULL([Email Type],'') + ' Key Date Alert' AS [Subject]
...
'If this needs to be updated or is incorrect please email Cumbria.Propertyview@Weightmans.com and we will update where necessary, otherwise you will receive another reminder in 1 month'
WHEN ISNULL([Email Type],'') ='1 Month' THEN 'If this needs to be updated or is incorrect please email ' + 'Cumbria.Propertyview@Weightmans.com'  + ' and we will update where necessary, otherwise you will receive another reminder in 3 weeks'
WHEN ISNULL([Email Type],'')='1 Week' THEN 'If this needs to be updated or is incorrect please email Cumbria.Propertyview@Weightmans.com and we will update where necessary.'
ELSE 'If this needs to be updated or is incorrect please email Cumbria.Propertyview@Weightmans.com and we will update where necessary.' END + '<p>' + 'Kindest regards' + '<p>' + 'Weightmans' AS Body
FROM 
(
...
WHERE  dim_matter_header_current.client_code='00243439'
...
SELECT CASE WHEN @test=1 THEN 'emily.smith@Weightmans.com' ELSE 'Janice.Weatherly@Weightmans.com' END  AS [To]
,'Cumbria ' + ISNULL([Email Type],'') + 'Key Date Alert' AS [Subject]
,PRO1594 AS [Date Alert]
,'<font size="2" face= "Lucida Sans Unicode">Dear All, <p> The Tenant Break Date for ' +  ISNULL(RTRIM(PRO1350),'') +
...
WHEN ISNULL([Email Type],'') ='1 Month' THEN 'If this needs to be updated or is incorrect please email '  + 'Cumbria.Propertyview@Weightmans.com' + ' and we will update where necessary, otherwise you will receive another reminder in 3 weeks'
WHEN ISNULL([Email Type],'')='1 Week' THEN 'If this needs to be updated or is incorrect please email Cumbria.Propertyview@Weightmans.com and we will update where necessary.'
ELSE 'If this needs to be updated or is incorrect please email Cumbria.Propertyview@Weightmans.com and we will update where necessary.' END + '<p>' + 'Kind regards' + '<p>' + 'Weightmans'
FROM 
(
...
WHEN ISNULL([Email Type],'') ='1 Month' THEN 'If this needs to be updated or is incorrect please email ' + 'Cumbria.Propertyview@Weightmans.com'  + ' and we will update where necessary, otherwise you will receive another reminder in 3 weeks'
WHEN ISNULL([Email Type],'')='1 Week' THEN 'If this needs to be updated or is incorrect please email Cumbria.Propertyview@Weightmans.com and we will update where necessary.'
ELSE 'If this needs to be updated or is incorrect please email Cumbria.Propertyview@Weightmans.com and we will update where necessary.' END + '<p>' + 'Kindest regards' + '<p>' + 'Weightmans'
FROM 
(
