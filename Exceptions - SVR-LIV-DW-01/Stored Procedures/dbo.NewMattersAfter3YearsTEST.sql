...
CREATE PROCEDURE [dbo].[NewMattersAfter3YearsTEST] --EXEC [dbo].[NewMattersAfter3Years] '2017-08-23','2017-08-23'
(	@StartDate	DATE
,	@EndDate	DATE
)
...
,TotalMatters.ProfitCostsBilled
...
LEFT OUTER JOIN (
SELECT dim_client.client_code,COUNT(1) AS TotalMatters ,SUM(defence_costs_billed) AS Revenue, SUM(fees_total) AS ProfitCostsBilled
...
INNER JOIN red_dw.dbo.fact_finance_summary
 ...
 LEFT JOIN  red_dw..fact_bill_matter_detail  
