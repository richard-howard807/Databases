...
-- =============================================
CREATE PROCEDURE [MMI].[MMI_Quarterly_Report]
...
case WHEN client <> 'M00001' then WPS278.case_value + WPS279.case_value ELSE 0 end [Paid Damages],
CASE WHEN client <> 'M00001' THEN WPS281.case_value  else NMI122.case_value  end [Paid CRU],
case WHEN client <> 'M00001' then WPS280.case_value  ELSE 0 END [Paid Claimant’s Costs],
case WHEN client <> 'M00001' then WPS340.case_value + WPS341.case_value ELSE 0 END [Paid Own Costs],
NULL AS [Total Paid],
...
,NMI411.case_text [Referral Reason]
,VE00571.case_date [Date Settlement Form sent to Zurich]
,WPS277.case_value WPS277
...
LEFT JOIN axxia01.dbo.casdet WPS277 ON cashdr.case_id = WPS277.case_id  AND WPS277.case_detail_code = 'WPS277' AND WPS277.cd_parent = WPS275.seq_no
...
LEFT JOIN axxia01.dbo.casdet NMI411 ON cashdr.case_id = NMI411.case_id  AND NMI411.case_detail_code = 'NMI411'
 
WHERE 
(date_closed >= '2018-01-01' OR date_closed IS NULL) and 
(VE00571.case_date >= '2018-01-01' OR VE00571.case_date IS NULL) and
(client = 'M00001' OR ( WPS332.case_text IS NOT NULL AND WPS332.case_text = 'MMI') )
ORDER BY cashdr.client , matter
