...
CREATE PROCEDURE [dbo].[ManchesterCityCouncilBordereau]	  -- EXEC  [dbo].[ManchesterCityCouncilBordereau]	'20220401','20220430'
(
@StartDate AS DATE
,@EndDate AS DATE
)
...
WHERE master_client_code='704563'
AND bill_date BETWEEN @StartDate AND @EndDate
AND fact_bill.bill_number <>'PURGE'
AND hierarchylevel4hist =  'Property Litigation'
