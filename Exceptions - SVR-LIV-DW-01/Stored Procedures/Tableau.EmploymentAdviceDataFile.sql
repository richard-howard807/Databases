...
Description:		Employment Advice Data for Tableau (using TGIF as the test data subject)
...
CREATE PROCEDURE [Tableau].[EmploymentAdviceDataFile]
...
SELECT  
		...
		, CASE WHEN dim_detail_core_details.[emp_litigatednonlitigated]  IN ('Contentious','Litigated') THEN 'Tribunal'
			...
			WHEN dim_matter_worktype.[work_type_code] ='1114' THEN 'Advisory'
...
AND dim_detail_advice.client_code IN ('00651833','W15597')
AND dim_matter_worktype.work_type_code = '1114'
AND dim_matter_header_current.matter_number NOT IN ('00000696','00000570','00000675','00000464','00000555','00000231','00000685')
