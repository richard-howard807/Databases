...
--Report Logic
--Total amount billed is not 0 or null
--AND total billed + fees total in the last 2 financial years prior to the date parameter is not 0
--AND (Insured sector is 'Local & Central Government' OR client sector is 'Local & Central Government')
--OR insured client name contains 'council' OR 'borough' OR 'mbc'
--Type Logic
--Work type group is 'EL','PL All','Disease','Claims Handling','Motor','Insurance Costs','Prof Risk','NHSLA','LMT','Recovery'
--OR work type name starts 'Speciality:' then 'Litigation Work'
--everything else is 'Core Work'
