...
--		   JL 14-09-2022 addded in new field called "Action for Trust" for ticket #167318 
-- =============================================
...
-- For testing
--==============================================================================================================================================
--DECLARE @def_trust AS VARCHAR(MAX) = 'Missing|Derbyshire Healthcare NHS Foundation Trust|University Hospitals of North Midlands NHS Trust|Chelsea & Westminster Hospital NHS Foundation Trust' 
...
--		, @case_handler AS VARCHAR(MAX)	 = 'Vanessa Splaine'
--==========================================================================================================================================================================================
-- Parameter queries
--==========================================================================================================================================================================================
...
SELECT 
	...
	,[Risk Management Recommendations] =CASE WHEN dim_detail_health.nhs_risk_management_recommendations IS NOT NULL THEN dim_detail_health.nhs_risk_management_recommendations
	 ...
	 ,dim_detail_health.actions_for_trust
...
FROM red_dw.dbo.fact_dimension_main
	...
	INNER JOIN #case_handler
		ON #case_handler.ListValue COLLATE DATABASE_DEFAULT = dim_matter_header_current.matter_owner_full_name
