...
CREATE PROCEDURE [dbo].[inquestreport]--EXEC [dbo].[inquestreport] 'Casualty Liverpool 2','Open' ,'Inquest                                 ',NULL,NULL
...
SELECT
     ...
     --  reg_cause_code [Cause Code],
	   date_initial_report_sent [Date Initial Report Sent],
	   reg_cause_code_desc [Cause Code],
       ...
       reg_verdict [Conclusion        ], 
		...
		fact_finance_summary.disbursement_balance [Disbursements Unbilled],
