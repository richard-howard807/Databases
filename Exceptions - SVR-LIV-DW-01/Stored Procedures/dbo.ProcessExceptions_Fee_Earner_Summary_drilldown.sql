...
CREATE PROCEDURE [dbo].[ProcessExceptions_Fee_Earner_Summary_drilldown]
(
...
FROM red_dw.dbo.fact_dimension_main
    ...
    LEFT JOIN red_dw.dbo.dim_fed_hierarchy_history
         ON dim_fed_hierarchy_history.fed_code = dim_matter_header_current.fee_earner_code AND dim_fed_hierarchy_history.dss_current_flag = 'Y' AND dim_fed_hierarchy_history.activeud = 1 -- Updated By MT from ON dim_fed_hierarchy_history.dim_fed_hierarchy_history_key = fact_dimension_main.dim_fed_hierarchy_history_key
    ...
    (
        ...
        FROM red_dw.dbo.fact_exceptions_update ex
            ...
            LEFT JOIN red_dw.dbo.dim_fed_hierarchy_history dfhh
                 ON dfhh.fed_code = dmhc.fee_earner_code AND dfhh.dss_current_flag = 'Y' AND dfhh.activeud = 1 -- Updated by MT from  ON dfhh.dim_fed_hierarchy_history_key = fdm.dim_fed_hierarchy_history_key
