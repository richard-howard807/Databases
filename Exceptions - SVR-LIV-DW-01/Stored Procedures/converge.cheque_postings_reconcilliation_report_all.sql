...
CREATE PROCEDURE [converge].[cheque_postings_reconcilliation_report_all] 
(
...
AS 
   ...
   -- DECLARE  @StartDate AS DATETIME = NULL
	...
	AND (tb.postsource IN ( 'TRSTDISB', 'TRSTRCPT')
			OR (tb.postsource ='TRSTADJ' AND IsReversed	=0 AND tb.IsDeposit= 0))	-- LD 1.3
