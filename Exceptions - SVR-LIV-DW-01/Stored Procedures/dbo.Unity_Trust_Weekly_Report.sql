...
-- Description:	New report for Unity Trust, copy of Midland Heart #137365
-- =============================================

--exec [dbo].[MidlandHeartSocialHousingWeeklyReport]
CREATE PROCEDURE [dbo].[Unity_Trust_Weekly_Report]
AS
BEGIN
...
AND fact_dimension_main.client_code = 'W23793'
