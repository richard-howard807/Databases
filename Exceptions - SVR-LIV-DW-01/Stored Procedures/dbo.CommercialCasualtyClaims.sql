...
,CASE WHEN CONVERT(DATE,date_opened_case_management,103)  BETWEEN @StartDate AND @EndDate  THEN 1 ELSE 0 END AS OPenFilter
,CASE WHEN CONVERT(DATE,date_claim_concluded,103)  BETWEEN @StartDate AND @EndDate  THEN 1 ELSE 0 END AS ConcludedFilter
