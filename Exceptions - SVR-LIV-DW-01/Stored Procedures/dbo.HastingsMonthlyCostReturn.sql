...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[HastingsMonthlyCostReturn] -- EXEC [dbo].[HastingsMonthlyCostReturn]  '2022-01-01','2022-12-28','Costs Settlement'
(
@StartDate AS DATE
,@EndDate  AS DATE
...
--AND bill_date BETWEEN '2021-12-01' AND '2022-12-02'
...
WHERE
	...
	--AND BudgetDates.BudgetDate BETWEEN '2021-12-01' AND '2022-12-02'
