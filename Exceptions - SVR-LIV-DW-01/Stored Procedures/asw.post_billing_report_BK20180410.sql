...
-- =========================================================================================
CREATE PROCEDURE [asw].[post_billing_report_BK20180410]
(
	@StartDate DATE
	,@EndDate DATE 
...
AS
	...
	SELECT
       ...
       --     ,invoices.Invoices
			,bills.fees fees_total
			,bills.disbs [disbs]
			,bills.disbs_vat + bills.fees_vat [vat]
			,bills.fees+bills.disbs+bills.disbs_vat + bills.fees_vat  bill_total 
