...
CREATE Procedure [Exceptions].[FeeEarnerSummaryLargeLoss] (
 @DatasetID as nvarchar(100)
,@FeeEarnerCode  as nvarchar(max)
,@ClientGroup as nvarchar(100))
as
begin
-- Test Paramaters
--declare @DatasetID as nvarchar(100) = '42,43,44'
--declare @FeeEarnerCode  as nvarchar(max) = 'AAZ,AGL,AHM,AKR1,ALN,AMY,AOC2,AWR,BHD,BWM,CCL1,CHM,CLM,DAH,DCT,DJC,DJN,DKE,DSC,DWL,EDX,EJW,EMC,EMC1,EPX,FEA,HCK,HMM,JBI,JCP,JNG,JTW6,KMJ,KSM,LCN,LUE,MPO,MSS,MSY,NAD,NDN,NRC,NSX,NTH,OGM,PAS,PAT,PAU,PPF,PRP,RBZ,RLW,RMC,RMS,SDP,SDP1,SEH1,SJW,SHO,SVS,TBS,TSM,TSX,TUD2,VEC,WAQ'
--declare @ClientGroup as nvarchar(100) = 'ALL';
...
,           caselist
              AS ( SELECT DISTINCT
                   ...
                   JOIN     red_dw.dbo.ds_sh_axxia_caclient caclient
