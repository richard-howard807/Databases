CREATE TABLE [dbo].[BillsIntoMatterPlans]
(
...
[Does Doc Exist] [int] NOT NULL CONSTRAINT [DF__BillsInto__Does __320C68B7] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[BillsIntoMatterPlans] ADD CONSTRAINT [PK_ID] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
