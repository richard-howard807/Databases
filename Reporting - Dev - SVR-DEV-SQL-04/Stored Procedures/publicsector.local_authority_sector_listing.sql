...
CREATE PROCEDURE [publicsector].[local_authority_sector_listing] 
...
BEGIN
   ...
   -- DECLARE @period_from DATE = '20170501'
			--,@period_to DATE = '20170801'
	...
	FROM red_dw.dbo.dim_matter_header_current matter 
		...
		INNER JOIN (SELECT 
			...
			AND (core.[insured_sector] = 'Local & Central Government' OR core.[insured_sector] IS NULL)
