...
-- =============================================
-- LD 20180405 Removed Client partner from #GeneratorStatus because of the following issue
--				SELECT client_code, master_client_code FROM red_dw.dbo.dim_matter_header_current WHERE client_code = '00238447'
-- ============================================
CREATE PROCEDURE [marketing].[generator_programme_report_summary]
(
...
AS
	...
	SELECT  
			...
			,ISNULL(udClientGroup.[description], dbClient.clName)[client_group_name]
