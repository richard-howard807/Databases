...
WHEN a.client_name IN ('Argo Managing Agency Limited','Barbican Insurance Group Syndicate 1955 at Lloyds','Markel (UK) Limited','W R Berkley Insurance Europe Ltd') THEN 'Med Mal'
WHEN a.client_name='RSA Insurance Group' AND hierarchylevel3hist <>'Regulatory' THEN 'Med Mal'
WHEN a.client_name IN ('CFC Underwriting Ltd','Medical & Dental Defence Union Of Scotland','Medical Defence Union','Medical Protection Society') THEN 'MDOs'
WHEN a.client_name='RSA Insurance Group' AND hierarchylevel3hist ='Regulatory' THEN 'MDOs'

ELSE 'Direct Instructions' END
