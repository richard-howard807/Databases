...
WHERE [nhs_scheme] = @Scheme
AND ( [output_wip_fee_arrangement]='Hourly rate' OR [nhs_scheme]='Inquest Funding' OR ([nhs_scheme]='CNST' AND [output_wip_fee_arrangement]<>'Hourly rate'  AND [nhs_instruction_type]='Inquest - associated claim') )
