...
, CASE WHEN COALESCE(cboReForProc.cdDesc, API.[cboReForProc_CaseText]  ) = 'Quantum dispute' THEN 'Quantum disputes' ELSE COALESCE(cboReForProc.cdDesc, API.[cboReForProc_CaseText]  ) END [Reason for proceedings]  -- udMICoreAXA
