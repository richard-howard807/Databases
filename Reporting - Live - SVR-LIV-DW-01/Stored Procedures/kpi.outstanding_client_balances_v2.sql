...
*/
CREATE PROCEDURE [kpi].[outstanding_client_balances_v2]
...
-- For testing purposes
	--DECLARE @FedCode VARCHAR(max)= '1089|1089|1089|1089|1089'
...
AND dim_fed_hierarchy_current_key IN
              (
                  SELECT (CASE
