...
CREATE PROCEDURE [Newcastle].[HisCox] 
...
WHERE ( Matter.number LIKE 'WB164642%'
OR Matter.number LIKE 'WB170835%'
OR Matter.number LIKE 'WB146164%')
...
WHERE clNo IN ('WB164642','WB170835','WB146164')
