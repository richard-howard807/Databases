...
FROM red_dw.dbo.dim_matter_header_current h_curr 
	INNER JOIN red_dw.dbo.fact_dimension_main
		ON fact_dimension_main.dim_matter_header_curr_key = h_curr.dim_matter_header_curr_key
...
FROM red_dw.dbo.dim_matter_header_current																							AS h_current
	...
	LEFT OUTER JOIN red_dw.dbo.fact_bill_detail_summary																				AS fact_bill_detail_summary
