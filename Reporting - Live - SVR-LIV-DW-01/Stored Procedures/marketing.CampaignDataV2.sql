...
CREATE PROCEDURE [marketing].[CampaignDataV2] --EXEC [marketing].[CampaignDataV2] '2022-01-01','2022-02-01','Coronavirus' 
(
@DateFrom AS DATE
,@DateTo AS DATE
...
INNER JOIN #Campaign AS Campaign ON Campaign.ListValue COLLATE DATABASE_DEFAULT =dbo.CampaignView.Campaign
