...
WHEN tskFilter='tsk_072_01_010_ClientCare' THEN 'Client Care process' END AS [Display_Name]
...
WHEN tskFilter='tsk_065_01_960_AllocationNewMatter' THEN 'EML Allocation of New Matter'
WHEN tskFilter='tsk_065_01_961_NewMatterDataCollection' THEN 'New Matter data collection' 
WHEN tskFilter='tsk_072_01_010_ClientCare' THEN 'Client Care process' END) =@DisplayName
END
