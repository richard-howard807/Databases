...
CREATE PROCEDURE [CommercialRecoveries].[StratfordClientReport]
AS
BEGIN
...
,ISNULL(TotalCollections,0) AS [Amount Recovd]
...
,txtCurentAction AS CurrentAction
...
WHERE (CRSystemSourceID  LIKE '30535-%' OR clNo='FW27456' 
)
AND fileType='2038'
AND CRSystemSourceID NOT IN ('30535-142','30535-143')
