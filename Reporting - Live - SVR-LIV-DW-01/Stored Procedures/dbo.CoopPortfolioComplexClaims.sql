...
AND clients_claims_handler_surname_forename IN ('Byrne, Paul','Cain, Andrew','Gallagher, Saul','Hinchcliffe, Andrea','Leaver, Mark','Maher, Michelle','Parton, Shirley','Stead, Nicola','Webber, Elayne','Wilson, Louise', 'Wild, David','Greene, Marilyn')
