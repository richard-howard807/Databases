...
CREATE PROCEDURE [dbo].[AIGBudgetsAndBillingCombinedBudgetOnly]
...
--AND ISNULL(red_dw.dbo.dim_detail_core_details.present_position,'') 
--NOT IN ('To be closed/minor balances to be clear','Final bill sent - unpaid')
