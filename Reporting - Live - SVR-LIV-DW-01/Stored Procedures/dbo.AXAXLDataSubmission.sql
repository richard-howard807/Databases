...
, CASE  WHEN TRIM(insuredclient_name) = 'DreamBalloon ApS' then  'Aviation'
...
,  CASE WHEN TRIM(insuredclient_name) = 'DreamBalloon ApS' then 'Other'
...
, COALESCE(dim_detail_claim.[dst_insured_client_name], insuredclient_name) AS [Insured Name]
