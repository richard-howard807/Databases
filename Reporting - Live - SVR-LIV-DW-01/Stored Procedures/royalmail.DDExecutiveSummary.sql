...
CREATE PROCEDURE [royalmail].[DDExecutiveSummary]
AS
begin
...
(
    [BE No] nVARCHAR(max),
    [BE Name] nVARCHAR(max),
    [Address] nVARCHAR(max),
    [PostCode] nVARCHAR(max),
    [Region] nVARCHAR(max),
    [RU Type] nVARCHAR(max),
    [Tenure] nVARCHAR(max),
    [Rental Value - payable] nVARCHAR(max),
    [Rental Value - receivable] nVARCHAR(max),
    [Rental Value] INT,
    [Term remaining] date,
    [Assignment] nVARCHAR(max),
    [Subletting] nVARCHAR(max),
    [Structural alterations] nVARCHAR(max),
    [Non-Structural alterations] nVARCHAR(max),
    [Landlord Break] date,
    [Tenant Break] date,
    [LTA 1954] nVARCHAR(max),
    [Yield Up] nVARCHAR(max),
    [Alterations] VARCHAR(max),
    [Next Review Date] date,
    [ChangeControl] nVARCHAR(max),
    [CaseNumber] INT,
    [case_id] INT,
    [TitleExclusion] nVARCHAR(max),
    [Country] nVARCHAR(max),
    [LinkRemoval] nVARCHAR(max)
);

--FREEHOLD Titles
--PRINT 'FREEHOLD Titles result: '
...
--PRINT 'Leasehold as Landlord <15k result: '
INSERT INTO #temptable
SELECT be_number,
       be_name,
       property_address,
...
--PRINT 'Leasehold as Tenant 1-25k result: '
INSERT INTO #temptable
SELECT be_number,
       be_name,
       property_address,
...
,Country
,LinkRemoval
 FROM #temptable AS CombinedData
 ) AS AllData
