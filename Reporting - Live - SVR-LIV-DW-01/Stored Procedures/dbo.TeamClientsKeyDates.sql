...
Description:		Matters with key dates coming up in dates specified. Used MotorKeyDates SP as template
Ticket:				53141
...
CREATE PROCEDURE [dbo].[TeamClientsKeyDates]  --EXEC TeamCLientsKeyDates '2020-03-15','2020-04-15'
(
@StartDate AS DATE
,@EndDate AS DATE
)
