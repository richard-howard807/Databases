...
-- =============================================
CREATE PROCEDURE [dbo].[Midland_Heart_LegalPanelBillingReport]
...
,CASE WHEN work_type_name IN ('Commercial Contracts', 'Commercial drafting (advice)','Company') THEN 'Contracts, Commercials, Procurement, Health and Safety' 
ELSE 'oTHER' END AS TEST
...
--SELECT * FROM  red_dw.dbo.dim_matter_header_current WHERE client_code = 'W23552' AND dim_matter_header_current.reporting_exclusions=0
GO
