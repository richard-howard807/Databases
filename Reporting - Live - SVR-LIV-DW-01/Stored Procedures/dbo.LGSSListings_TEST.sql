...
CREATE PROCEDURE [dbo].[LGSSListings_TEST]
...
WHEN ISNULL(red_dw.dbo.dim_matter_header_current.present_position,'') = 'To be closed/minor balances to be clear' THEN 'Closed'
ELSE 'Open' END 
