...
CREATE  PROCEDURE [dbo].[RealEstateKPIReports_TEST] -- EXEC RealEstateKPIReports '6034'
(
...
,DATEDIFF(DAY,CONVERT(DATE,date_instructions_received,103),CONVERT(DATE,dim_detail_plot_details.exchange_date,103)) AS [Elapsed Days to Exchange]
,CompletionDateCompleted AS [Date Completion Process Completed]
,DATEDIFF(DAY,CONVERT(DATE,date_instructions_received,103),CONVERT(DATE,dim_detail_plot_details.pscompletion_date,103))  AS [Elapsed Days to Completion]
,work_type_name
