...
CREATE PROCEDURE [dbo].[PostMatterSampleOpenDataRange] -- EXEC dbo.PostMatterSampleDataRange '2021-04-01','2021-04-30'
...
AND dim_matter_header_current.date_opened_case_management>='2021-03-01'
