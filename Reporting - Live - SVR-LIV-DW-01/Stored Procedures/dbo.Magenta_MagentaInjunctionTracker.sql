...
SELECT 
	...
	,[Tenant's Postcode] = right(dim_matter_header_current.matter_description,charindex(' ',reverse(dim_matter_header_current.matter_description))+4)--RIGHT(dim_matter_header_current.matter_description,CHARINDEX(',',REVERSE(dim_matter_header_current.matter_description))-1) 
	,matter_description
  ,ms_fileid
  ,instruction_type
