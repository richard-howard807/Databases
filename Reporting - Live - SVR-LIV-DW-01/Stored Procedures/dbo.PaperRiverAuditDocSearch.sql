...
--EXEC [dbo].[PaperRiverAuditDocSearch] '26415416',NULL

CREATE PROCEDURE [dbo].[PaperRiverAuditDocSearch]
(
...
FROM [SVR-LIV-3PTY-01].PaperRiverAudit.dbo.RecentAuditLog WITH(NOLOCK)
