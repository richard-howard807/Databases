...
CREATE PROCEDURE [dbo].[AvivaasInsurerListingReport_SN]
...
WHERE master_client_code = '817628'
...
LEFT JOIN #Payornames ON #Payornames.dim_matter_header_curr_key = dim_matter_header_current.dim_matter_header_curr_key
	WHERE fact_dimension_main.master_client_code = '817628'
        
       AND  
	   (date_closed_case_management>'2015-01-01'
	   OR  date_closed_case_management IS NULL  )
