...
CREATE PROCEDURE [dbo].[AgeasQuarterlyBillingV2] --EXEC dbo.AgeasQuarterlyBilling '2018-01-01','2018-12-31'
(
@StartDate AS DATE
,@EndDate AS DATE
)
...
BEGIN
SELECT 
COALESCE(dim_client_involvement.insurerclient_reference, dim_client_involvement.client_reference) AS [Ageas reference]
...
,SUM(BillAmt) AS Total
,SUM(BillHrs) AS HrsBilled

,SUM(CASE WHEN RTRIM(dim_fed_hierarchy_history.fed_code)=RTRIM(MatterOwner.fed_code) AND dim_fed_hierarchy_history.fed_code NOT  IN 
...
THEN BillAmt ELSE 0 END)  AS [Lead Billed]

,SUM(CASE WHEN RTRIM(dim_fed_hierarchy_history.fed_code)=RTRIM(MatterOwner.fed_code) AND dim_fed_hierarchy_history.fed_code NOT  IN 
('5547','3216','3691','1924','4493','4560','4348','4815','1713','4234','3113','5113','5386','5644','3094','4878','4105','3662'
,'4410','2033','5607','4204','4846','4387','5009','5427','4941','5569','4660','4828','4874','4456') THEN BillHrs ELSE 0 END)  AS [Lead Billed Hrs]

,SUM(CASE WHEN dim_fed_hierarchy_history.fed_code IN 
('5547','3216','3691','1924','4493','4560','4348','4815','1713','4234','3113','5113','5386','5644','3094','4878','4105','3662'
,'4410','2033','5607','4204','4846','4387','5009','5427','4941','5569','4660','4828','4874','4456') THEN  BillAmt ELSE 0 END)  AS [Cost Team Billed]

,SUM(CASE WHEN dim_fed_hierarchy_history.fed_code IN 
('5547','3216','3691','1924','4493','4560','4348','4815','1713','4234','3113','5113','5386','5644','3094','4878','4105','3662'
,'4410','2033','5607','4204','4846','4387','5009','5427','4941','5569','4660','4828','4874','4456') THEN BillHrs  ELSE 0 END)  AS [Cost Team Billed Hrs]
,tier_1_3_case
...
LEFT OUTER JOIN red_dw.dbo.dim_fed_hierarchy_history AS MatterOwner
 ON MatterOwner.fed_code=fee_earner_code COLLATE DATABASE_DEFAULT AND MatterOwner.dss_current_flag='Y'
WHERE dim_matter_header_current.client_group_name='Ageas'
--AND dim_bill.bill_number='01944802'
