...
SELECT 
 dim_matter_header_current.master_client_code+'-'+dim_matter_header_current.master_matter_number AS [Nr.]
, NULL AS [Country]
, CAST([date_opened].cal_year AS VARCHAR(4)) +' Q'+ CAST([date_opened].cal_quarter_no AS VARCHAR(1)) AS [Year and Quarter]
, NULL AS [Claim number]
, NULL AS [Nr of PAX]
, NULL AS [AOC]
...
, NULL AS [Own attorney fee (EUR)]
, NULL AS [Other expenses (EUR)]
