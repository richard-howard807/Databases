CREATE TABLE [dbo].[DisbsIntoMatterPlans]
(
...
[Does Doc Exist] [int] NOT NULL CONSTRAINT [DF__DisbsInto__Does __1E105D02] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[DisbsIntoMatterPlans] ADD CONSTRAINT [PK_DisbID] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
