...
SELECT [Actuals].segment,
	   ...
	   [Actuals].outstanding_total_bill_90_days,
       [Actuals].outstanding_costs,
       [Actuals].outstanding_costs_180_days,
	   [Actuals].outstanding_costs_90_days,
       [Actuals].wip_minutes,
       [Actuals].wip_value,
	   ...
	   PREVIOUS_DATA.outstanding_total_bill_90_days AS outstanding_total_bill_90_days_previous_year_month,
...
FROM
 ...
 (
    SELECT CASE WHEN segment IS NULL OR sector IS NULL THEN 'Misc'ELSE segment end segment,
		   ...
		   SUM(outstanding_total_bill_90_days) outstanding_total_bill_90_days,
           SUM(outstanding_costs) outstanding_costs,
           SUM(outstanding_costs_180_days) outstanding_costs_180_days,
		   SUM(outstanding_costs_90_days) outstanding_costs_90_days,
