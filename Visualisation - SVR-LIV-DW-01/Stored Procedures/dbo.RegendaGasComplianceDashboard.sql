...
-- Description:	#105442, new dashboard for renganda group

-- =============================================
CREATE PROCEDURE [dbo].[RegendaGasComplianceDashboard]
...
WHERE 
dim_matter_header_current.master_client_code = '122465T'
AND  dim_matter_worktype.[work_type_name] = 'Injunction'
AND (dim_matter_header_current.matter_description LIKE '%GAS%' OR dim_matter_header_current.matter_description LIKE '%ELEC%')
