...
--			, 12 [Previous Month]
--			, 2019 [Current Year]
--			, CASE WHEN (DATEPART(MONTH, dim_matter_header_current.date_opened_case_management) = 12  AND DATEPART(YEAR, dim_matter_header_current.date_opened_case_management) = 2019) THEN '1' ELSE '0' END [New (Month)]

--		, CASE WHEN (DATEPART(MONTH, dim_detail_property.[completion_date]) = 12 AND DATEPART(YEAR, dim_detail_property.[completion_date]) = 2019) THEN '1' ELSE '0' END [Completed (Month)]
--		, CASE WHEN DATEPART(YEAR, dim_matter_header_current.date_opened_case_management) = 2019  THEN '1' ELSE '0' END [New (Year)]
--		, CASE WHEN DATEPART(YEAR, dim_detail_property.[completion_date]) = 2019 THEN '1' ELSE '0' END [Completed (Year)]
--		, 'Matter Level' [Level]
...
--						, ARMaster.ARFee AS [ARFee]
--						, ARMaster.InvDate AS [InvDate]
--						, CASE WHEN DATEPART(YEAR, ARMaster.InvDate) = 2019  THEN ARMaster.ARFee ELSE '0' END [Legal Spend]
--						, CASE WHEN DATEPART(YEAR, ARMaster.InvDate) = 2019 AND (DATEPART(MONTH, ARMaster.InvDate) = 12) THEN ARMaster.ARFee ELSE '0' END [Current Legal Spend]
