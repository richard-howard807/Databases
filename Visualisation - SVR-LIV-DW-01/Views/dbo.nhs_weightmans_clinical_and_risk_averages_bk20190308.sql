...
CREATE VIEW [dbo].[nhs_weightmans_clinical_and_risk_averages_bk20190308]
...
SELECT --TOP 100* 
	...
	locationidud [matter_owner_office],
	CASE WHEN locationidud IN ('London NFL','London Hallmark') THEN 'London'
