...
CREATE PROC [dbo].[CUR_RunVFileContact]
AS
	 DECLARE 
	 @ID				INT,
	 @clName			NVARCHAR (80),
	...
	PRINT @ID
	--INSERT INTO dbo.VFContactSuccess
	--        ( ID, extContID, clNo, clName, cbocligrp, cbopartner,
	...
	--DELETE FROM dbo.VFContactStage WHERE ID = @ID
	END
	...
	PRINT @ID
	--INSERT INTO dbo.VFContactFailure
	--        ( ID, extContID, clNo, clName, cbocligrp, cbopartner,
	--          addid, addLine1, addLine2, addLine3, addLine4, addLine5,
	--          addPostCode, addCountry, addDXCode, contType, contSalut, contTitle,
	--          contFirstNames, contSurname, contSex, contNotes, contCreated, contEmail,
