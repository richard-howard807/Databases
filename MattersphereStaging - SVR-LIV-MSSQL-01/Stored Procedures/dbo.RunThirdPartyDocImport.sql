...
CREATE PROCEDURE [dbo].[RunThirdPartyDocImport]
(
	@FileID [BIGINT],
...
GO
GRANT EXECUTE ON  [dbo].[RunThirdPartyDocImport] TO [SBC\BluePrismService1]
GO
GRANT EXECUTE ON  [dbo].[RunThirdPartyDocImport] TO [SBC\SQL - Blueprism access SVR-LIV-MSSQ-01]
GO
GRANT EXECUTE ON  [dbo].[RunThirdPartyDocImport] TO [SBC\SQL - Blueprism execute specific MS_PROD]
GO
GRANT EXECUTE ON  [dbo].[RunThirdPartyDocImport] TO [SBC\SQL - XpertRule access SVR-LIV-MSSQ-01]
GO
