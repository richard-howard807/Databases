CREATE TABLE [dbo].[VFMatterCreationFailure]
(
...
[fileFundCode] [nvarchar] (15) COLLATE Latin1_General_CI_AS NOT NULL CONSTRAINT [DF__VFMatterC__fileF__5887175A] DEFAULT ('NOCHG'),
[fileCurISOCode] [nchar] (3) COLLATE Latin1_General_CI_AS NOT NULL CONSTRAINT [DF__VFMatterC__fileC__597B3B93] DEFAULT ('GBP'),
[fileStatus] [nvarchar] (15) COLLATE Latin1_General_CI_AS NULL,
[fileCreated] [datetime] NULL CONSTRAINT [DF__VFMatterC__fileC__5A6F5FCC] DEFAULT (getdate()),
[fileUpdated] [datetime] NULL,
[fileClosed] [datetime] NULL,
[fileSource] [nvarchar] (15) COLLATE Latin1_General_CI_AS NULL CONSTRAINT [DF__VFMatterC__fileS__5B638405] DEFAULT ('IMPORT'),
...
[StatusID] [tinyint] NOT NULL CONSTRAINT [DF__VFMatterC__Statu__5C57A83E] DEFAULT ((0)),
[error] [int] NULL,
