CREATE TABLE [dbo].[CaseDetailsStage]
(
...
[InsertDate] [datetime] NOT NULL CONSTRAINT [DF__CaseDetai__Inser__2FCF1A8A] DEFAULT (getdate()),
[Imported] [datetime] NULL,
[StatusID] [tinyint] NOT NULL CONSTRAINT [DF__CaseDetai__Statu__30C33EC3] DEFAULT ((0)),
[error] [int] NULL,
[errormsg] [varchar] (2000) COLLATE Latin1_General_CI_AS NULL
) ON [PRIMARY]
GO
GRANT SELECT ON  [dbo].[CaseDetailsStage] TO [SBC\sreeve01]
GO
