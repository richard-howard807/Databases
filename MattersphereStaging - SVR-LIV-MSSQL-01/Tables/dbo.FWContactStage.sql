CREATE TABLE [dbo].[FWContactStage]
(
...
[brID] [int] NULL CONSTRAINT [DF__FWContactS__brID__1C3D2329] DEFAULT ((1)),
[contSubType] [nvarchar] (15) COLLATE Latin1_General_CI_AS NULL,
[InsertDate] [datetime] NOT NULL CONSTRAINT [DF__FWContact__Inser__1D314762] DEFAULT (getdate()),
[Imported] [datetime] NULL,
[StatusID] [tinyint] NOT NULL CONSTRAINT [DF__FWContact__Statu__1E256B9B] DEFAULT ((0)),
[error] [int] NULL,
