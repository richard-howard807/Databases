CREATE TABLE [dbo].[FWContactSuccess]
(
[ID] [int] NOT NULL,
...
[brID] [int] NULL CONSTRAINT [DF__FWContactS__brID__3F865F66] DEFAULT ((1)),
[contSubType] [nvarchar] (15) COLLATE Latin1_General_CI_AS NULL,
[InsertDate] [datetime] NOT NULL CONSTRAINT [DF__FWContact__Inser__407A839F] DEFAULT (getdate()),
[Imported] [datetime] NULL,
[StatusID] [tinyint] NOT NULL CONSTRAINT [DF__FWContact__Statu__416EA7D8] DEFAULT ((0)),
[error] [int] NULL,
